...
int main()
{
    ...
    do
    {
        cout<<"======================="<<endl;
         ...
         string phras = "Welcome Master Mritunjay ";
          string comman = "espeak \"" + phras + "\"";
                      const char *charComman = comman.c_str();
                    system(charComman);
        ...
        if(strcmp(password, "Mritunjay")==0){
            cout<<"\n<==================================================================================================>\n\n";
            wishme();
            do{
                cout<<"\n<==================================================================================================>\n\n";
                ...
                string phrase = "How can i help you Mritunjay Sir";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"Good Bye Master Mritunjay, have a nice day!!!!"<<endl;
                    string phrase = "Good Bye Master Mritunjay, have a nice day";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
                    ...
                    cout<<"I'm a virtual assistant created by my master Mritunjay, Raunak and Abhay in presence of Shivendra and Suneel who has two cycles !!!"<<endl;
                    string phrase = "I'm a virtual assistant created by my master Mritunjay, Raunak and Abhay in presence of Shivendra and Suneel who has two cycles !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    system("start https://www.google.com");
                          ...
                          else if(strcmp(ch, "open universitywebsite") == 0){
                    cout<<"openining universitywebsite....."<<endl;
                    string phrase = "openning universitywebsite";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("start http://www.rmlau.ac.in/new/index.aspx");
                }
